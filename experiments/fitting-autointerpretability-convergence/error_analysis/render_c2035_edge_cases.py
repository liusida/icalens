#!/usr/bin/env python3
"""Render the saved C2035 edge-case probe as a self-contained HTML report."""
...
INPUT = ROOT / "results/c2035-edge-case-results.json"
OUTPUT = ROOT / "results/c2035-edge-case-results.html"
...
<title>Qwen iteration-50 L7/C2035 edge cases</title>
<style>
...
<body><main>
  <h1>Qwen iteration-50 · L7/C2035</h1>
